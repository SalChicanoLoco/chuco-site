...
def main() -> int:
    ...
    chat_production = require_file("sena-chat/PRODUCTION-TONIGHT.md")
    ...
    require_contains("sena-chat/PRODUCTION-TONIGHT.md", chat_production, "Use the **existing Clojure terminal app** tonight", "Production-tonight chat recommendation exists")
    ...
    require_contains("scripts/chat_check.py", chat_check, "claude-sonnet-4-6", "Chat default model is current Sonnet 4.6")
    require_contains("sena-chat/src/sena/chat/api.clj", require_file("sena-chat/src/sena/chat/api.clj"), "claude-sonnet-4-6", "Sena Chat API default model is current Sonnet 4.6")
